export const esMessages: Record<string, string> = {
  ...
  "views.admin.AiExtractSettings.allowList": "Lista blanca de direcciones (introduce la dirección y pulsa Enter; admite comodines)",
  ...
  "views.user.UserSettings.passordTip": "El servidor solo recibe el hash de la contraseña, no la contraseña en texto claro, por lo que no puede verla ni recuperarla. Si el administrador activa la verificación por correo, puedes restablecerla en el modo anónimo.",
  ...
  "components.AddressCredentialModal.tip": "Usa estas credenciales solo con clientes y agents de confianza.",

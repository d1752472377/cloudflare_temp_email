...
api.get('/admin/user_roles', async (c: Context<HonoCustomType>) => c.json(await getUserRoles(c)))
api.get('/admin/roles', admin_user_api.getRoles)
api.post('/admin/roles', admin_user_api.saveRoles)
